 ...
 */
final class Version20251220110453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE seats (id CHAR(36) NOT NULL, seat_row_number INT NOT NULL, seat_column_number INT NOT NULL, room_id CHAR(36) DEFAULT NULL, INDEX IDX_BFE2575054177093 (room_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
